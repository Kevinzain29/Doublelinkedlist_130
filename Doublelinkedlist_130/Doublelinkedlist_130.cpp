...
void DoubleLinkedList::addNode() {
	...
	/*inser a node in the beginning of a doubly - linked list*/
...
int main() {
	...
	while (true) {
		try {
			...
			cout << "4. View all records in the descending order of the roll numbers" << endl;
